...
def calculate_batch_complexity(
    ...
    # Fix #63: Guard for str/dict mixed list — keywords_for_batch może zawierać stringi
    total_keyword_uses = sum(k.get("uses_this_batch", 1) if isinstance(k, dict) else 1 for k in keywords_for_batch)
