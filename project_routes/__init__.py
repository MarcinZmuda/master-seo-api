"""
PROJECT HELPERS PACKAGE v44.2
=============================
Moduły pomocnicze wydzielone z project_routes.py (~1,700 linii).
...
Użycie w project_routes.py:
    ...
    from project_helpers.semantic_planning import create_semantic_keyword_plan
"""
...
try:
    ...
    print(f"[PROJECT_HELPERS] ⚠️ h2_routes not available: {e}")
